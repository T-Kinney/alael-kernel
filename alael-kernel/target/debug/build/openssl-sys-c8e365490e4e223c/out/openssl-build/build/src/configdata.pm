...
our %config = (
    ...
    "openssldir" => "SYS\$MANAGER:[OPENSSL]",
    "options" => "--prefix=C:/dev/zion-citadel/alael-kernel/target/debug/build/openssl-sys-c8e365490e4e223c/out/openssl-build/install --openssldir=SYS\$MANAGER:[OPENSSL] --libdir=lib no-acvp-tests no-afalgeng no-asan no-brotli no-brotli-dynamic no-buildtest-c++ no-camellia no-capieng no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-demos no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-jitter no-fips-post no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-h3demo no-hqinterop no-idea no-jitter no-ktls no-loadereng no-md2 no-module no-msan no-pie no-rc5 no-sctp no-seed no-shared no-ssl3 no-ssl3-method no-sslkeylog no-tests no-tfo no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "4",
    "perl_archname" => "MSWin32-x64-multi-thread",
    "perl_cmd" => "C:\\Strawberry\\perl\\bin\\perl.exe",
    "perl_version" => "5.42.0",
    "perlargv" => [
        "--prefix=C:/dev/zion-citadel/alael-kernel/target/debug/build/openssl-sys-c8e365490e4e223c/out/openssl-build/install",
        "--openssldir=SYS\$MANAGER:[OPENSSL]",
        "no-shared",
        "no-module",
        "no-tests",
...
unless (caller) {
    ...
    use lib 'C:/dev/zion-citadel/alael-kernel/target/debug/build/openssl-sys-c8e365490e4e223c/out/openssl-build/build/src/util/perl';
    use OpenSSL::fallback 'C:/dev/zion-citadel/alael-kernel/target/debug/build/openssl-sys-c8e365490e4e223c/out/openssl-build/build/src/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'C:/dev/zion-citadel/alael-kernel/target/debug/build/openssl-sys-c8e365490e4e223c/out/openssl-build/build/src/Configurations';
        use gentemplate;
